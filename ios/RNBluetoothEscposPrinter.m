...
{
    NSLog(@"printer init start");
    if(RNBluetoothManager.isConnected){
        NSLog(@"printer init connected");
        ...
        NSLog(@"printer init connect done");
    }else{
        NSLog(@"printer init reject");
